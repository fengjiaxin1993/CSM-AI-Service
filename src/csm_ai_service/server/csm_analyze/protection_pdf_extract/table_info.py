from csm_ai_service.server.csm_analyze.protection_pdf_extract.helper import is_contain, area_percent, clean
import fitz.table
...
def get_matrix(rows: list[fitz.table.TableRow], row_count: int, col_count: int):
...
# 存储TableInfo的详细信息
class TableInfo:
    def __init__(self, table: fitz.table.Table, mark_flag: bool, blocks: list,header_len:int):
        # ====1==== 获取表格的基本信息
