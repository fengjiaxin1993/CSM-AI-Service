...
from csm_ai_service.server.db.models.knowledge_base_model import KnowledgeBaseSchema
from csm_ai_service.server.db.repository.knowledge_base_repository import (
    add_kb_to_db,
    delete_kb_from_db,
    kb_exists,
    list_kbs_from_db,
...
from csm_ai_service.server.db.repository.knowledge_file_repository import (
    add_file_to_db,
    count_files_from_db,
    delete_file_from_db,
...
class KBService(ABC):
    ...
    def add_doc(self, kb_file: KnowledgeFile, docs: List[Document] = [], **kwargs):
        ...
        if docs:
            ...
            logger.info("文件【{}】 一共有 {} 个文档，向量化花费 {:.2f} 秒".format(kb_file.filename, len(docs), time.time() - start_time2))
    ...
    def list_docs(
        ...
        for x in doc_infos:
            ...
            if doc_info is not None:
                # 处理非空的情况
                doc_with_id = DocumentWithVSId(**doc_info.dict())
